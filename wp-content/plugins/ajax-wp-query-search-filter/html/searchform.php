...
if($formtitle){
	...
	do_action( 'awpqsf_form_top', $atts);
		...
		// LINES ADDED FROM ORGINAL PLUGIN
		echo '<div id="futurEventCheckbox" class="awpqsf_class">'.
			'<div class="checkbox btn texted-chkbx">'.
			'<input type="checkbox" checked="checked" id="eventToCome" name="eventToCome" value="eventToCome">'.
			'<label class="tax-label-4">N\'afficher que les événements à venir</label>'.
			'</div>'.
			'</div>';
		// END OF CUSTOM CODE
