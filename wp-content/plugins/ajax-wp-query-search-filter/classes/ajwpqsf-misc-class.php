		...
		if($type == 'checkbox'){
 			if ( $count > 0 ){
				...
				foreach ( $terms as $term ) {
					...
					if($taxname == 'public')
					{
						$html .= '<div class="checkbox btn imaged-chkbx">';
						$html .= '<input type="checkbox" id="taxcheckid-'.$c.'" name="taxo['.$c.'][term][]" value="'.$value.'" >';
						$html .= '<label class="">';
						$html .= '<div class="public-img">'. wp_get_attachment_image( $images[$termid], '' ). '</div>';
						$html .= '<span>'. $term->name .'</span>';
						$html .= '</label>';
					}
					elseif($taxname == 'discipline')
					{
						$html .= '<div class="checkbox btn imaged-chkbx">';
						$html .= '<input type="checkbox" id="taxcheckid-'.$c.'" name="taxo['.$c.'][term][]" value="'.$value.'" >';
						$html .= '<label class="">';
					...
					{
						$html .= '<div class="checkbox btn texted-chkbx">';
						$html .= '<input type="checkbox" id="taxcheckid-'.$c.'" name="taxo['.$c.'][term][]" value="'.$value.'" >';
						$html .= '<label class="taxchklabel">'. $term->name .'</label>';
					}
					$html .= '</div>';
				}
				$html .= '<br></div>';
