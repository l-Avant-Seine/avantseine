	...
	<header id="masthead" class="site-header cf" role="banner">
		...
		<div class="site-menus is-flex">
					...
					wp_nav_menu( array( 
						...
						'items_wrap' => '<ul class="siteMenuPrimary-inner menu-item no-bullets">
																...
																<li class="js-menuTrigger menu-item">
																	<a href="#"> <span class="icon-menu"></span> et aussi</a>
																</li>
															</ul>'
					) ); ?>

				<div id="ham-menu" class="siteMenus-large">
					<div class="wrap row">
						<?php 
							wp_nav_menu( array( 
								'theme_location' => 'all', 
			...
			<nav class="siteMenus-actions">
				<ul class="nobullets">
					<li id="menu-item-9455" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9455"><a href="http://lavant-seine.com/lieu/equipe/" class="btn-primary">nous contacter</a></li>
